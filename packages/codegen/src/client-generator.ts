#!/usr/bin/env node
/**
 * @ai-first/api-starter Codegen
 * 
 * 从 Controller/Entity/DTO 源码生成前端可用的 API Client
 * 
 * 两种使用方式：
 * 1. CLI: npx ai-first-codegen --src ./src --out ./dist/client
 * 2. API: import { generateApiClient } from '@ai-first/api-starter/codegen'
 */
